...
class Row(t.NamedTuple, t.Generic[_T]):
    pre: str
    fill: str
    node: _T
...
class RenderTree(t.Generic[_T]):

    def __init__(self, node:_T, style:AbstractStyle=ContStyle(), childiter=list, maxlevel=None):
        u"""
    ...
    def __next(self, node:_T, continues, level=0) -> t.Generator[Row[_T], None, None]:
